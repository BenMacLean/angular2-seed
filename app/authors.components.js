        ...
        execute: function() {
            AuthorComponent = (function () {
                function AuthorComponent() {
                    this.title = "The authors of courses page";
                }
                AuthorComponent.prototype.counstructor = function (authorService) {
                    this.authors = author_service_1.AuthorService.getAuthors();
                };
